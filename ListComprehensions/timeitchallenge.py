...
if __name__ == '__main__':
    ...
    result_iter = timeit.repeat(iteration, globals=globals(), number=10000, repeat=6)
    result_recur = timeit.repeat(recursion, globals=globals(), number=10000, repeat=6)
    print("iteration time is {}".format(result_iter))
    print("recursion time is {}".format(result_recur))

...
with shelve.open("loc_data") as loc_info:

    loc_info["locations"] = {0: {"desc": "You are sitting in front of a computer learning Python",
                     "exits": {},
                     "namedExits": {}},
    ...
    loc_info["vocabulary"] =  {"QUIT": "Q",
                                ...
                                "VALLEY": "4",
                                "FOREST": "5"}
    print(loc_info["vocabulary"])
    print(loc_info["locations"])
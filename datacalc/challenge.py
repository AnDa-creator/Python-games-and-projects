...
print("The info on the clock are ", time.get_clock_info("time"))
print()
print("The info on the clock are ", time.get_clock_info("perf_counter"))
print()
print("The info on the clock are ", time.get_clock_info("monotonic"))
print()
print("The info on the clock are ", time.get_clock_info("process_time"))
print()

...
class Head(Tag):
    ...
    def __init__(self, content=''):
        super().__init__('head', '')
        self.title = Tag('title', contents=content)

    def __str__(self):
        return "{0.start_tag}{1.start_tag}{1.contents}{1.end_tag}{0.end_tag}".format(self, self.title)
...
if __name__ == "__main__":
    # my_page = HtmlDoc("My fucking webpage")

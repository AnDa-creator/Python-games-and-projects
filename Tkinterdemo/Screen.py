...
optionFrame = tkinter.LabelFrame(mainWindow,
                                 text="File Details")
...
radio1 = tkinter.Radiobutton(optionFrame,
                             text="Filename", value=1,
                             variable=rbValue)
radio2 = tkinter.Radiobutton(optionFrame,
                             text="Path", value=2,
                             variable=rbValue)
radio3 = tkinter.Radiobutton(optionFrame, text="Timestamp",
...
timeFrame.grid(row=3, column=0,sticky='nw')

#Time spinners
hourSpinner = tkinter.Spinbox(timeFrame,width=2,
                              values=tuple(range(0,24)))
minuteSpinner = tkinter.Spinbox(timeFrame,width=2,
                                from_=0, to=59)
...
monthSpin = tkinter.Spinbox(
    dateFrame, width=5, values=("Jan", "Feb", "Mar",
                                ...
                                "Jul", "Aug", "Sep",
                                "Oct", "Nov", "Dec"))
yearSpin = tkinter.Spinbox(dateFrame, width=5,
                           from_=2000, to=2099)
